...
textin_array = np.load('trace_081/textin_array.npy')
trace_array = np.load('trace_081/trace_array.npy')
textout_array = np.load('trace_081/textout_array.npy')
...
print("Guessed Key : ", [hex(x)[2:] for x in key_guess])
